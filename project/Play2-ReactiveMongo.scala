  ...
  lazy val reactivemongo = Project(
    ...
    settings = buildSettings ++ Seq(
      ...
      libraryDependencies ++= Seq(
        "org.reactivemongo" %% "reactivemongo" % "0.10.5.0.akka22" cross CrossVersion.binary,
        "com.typesafe.play" %% "play" % "2.2.5" % "provided" cross CrossVersion.binary,
        "com.typesafe.play" %% "play-test" % "2.2.5" % "test" cross CrossVersion.binary,
